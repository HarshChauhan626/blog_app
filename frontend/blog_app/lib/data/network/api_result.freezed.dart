...
class _$ApiResultTearOff {
  ...
  Failure<T> failure<T>({required ApiFailure error}) {
    return Failure<T>(
      error: error,
    );
  }
...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiFailure error) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T data)? success,
    TResult Function(ApiFailure error)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure({required ApiFailure error}) = _$Failure<T>;
